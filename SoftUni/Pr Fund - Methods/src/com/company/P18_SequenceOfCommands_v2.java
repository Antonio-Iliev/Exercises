...
public class P18_SequenceOfCommands_v2 {
    ...
    static String AddCommand(long[] inputArray, int indexPos, long valueNum) {
        inputArray[indexPos - 1] += valueNum;
        return ReturnStringToPrint(inputArray);
    }

    static String MultiCommand(long[] inputArray, int indexPos, long valueNum) {
        inputArray[indexPos - 1] *= valueNum;

        return ReturnStringToPrint(inputArray);
    }

    static String SubtractCommand(long[] inputArray, int indexPos, long valueNum) {
        inputArray[indexPos - 1] -= valueNum;
